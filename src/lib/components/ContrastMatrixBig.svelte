...
<section class="big-matrix">
  <header>
    <div class="head-left">
      ...
      <span class="count">{shown.length} × {shown.length}</span>
    </div>
...
<style>
  ...
  .mt td.lvl-aaa { background: rgba(22, 163, 74, 0.55); color: #fff; }
  .mt td.lvl-aa { background: rgba(34, 197, 94, 0.45); color: #fff; }
  .mt td.lvl-aal { background: rgba(234, 179, 8, 0.4); color: #fff; }
  .mt td.lvl-ui { background: rgba(161, 98, 7, 0.45); color: #fff; }
  .mt td.lvl-fail { background: rgba(127, 29, 29, 0.45); color: var(--text); }
</style>
